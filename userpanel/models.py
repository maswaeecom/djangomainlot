...
class Transfer_records(models.Model):
    ...
    fromusername = models.CharField(unique=True ,max_length=50,null=True)
    tousername = models.CharField(unique=True ,max_length=50,null=True)
...
class Buychips(models.Model):
    ...
    date = models.DateTimeField(default=datetime.now, blank=True)
    chips= models.DecimalField(max_digits=10, decimal_places=2, null=True)
    status = models.CharField(max_length=100)
...
class Wallet(models.Model):
    ...
    level_earning = models.DecimalField(max_digits=19, decimal_places=2, null=True)
...
class Widhdraw_requests(models.Model):
    username= models.CharField(max_length=100, null=True)
    amount = models.DecimalField(max_digits=19, decimal_places=2, null=True)
    type = models.CharField(max_length=50, default="Pending")
