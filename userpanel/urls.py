...
urlpatterns = [
    ...
    path('chips_bought',views.chips_bought, name = 'chips_bought'),
    path('transfer_records',views.transfer_records, name = 'transfer_records'),
    ...
    path('with_request',views.with_request, name = 'with_request'),
